...
//     mainDiv.classList = 'member';
//
//     const h2 = document.createElement('h2');
//     h2.innerText = `${simpson.name} ${simpson.surname} - ${simpson.age} years old`;
//
...
//
//     const hourDuration = document.createElement('h4');
//     hourDuration.innerText = `Hour duration - ${item.hourDuration}`;
//
//     const ulDiv = document.createElement("div");
//     const titleDiv = document.createElement("h5");
//     titleDiv.innerText = `Item modules:`
...
//
//     htmlDiv.appendChild(mainDiv);
//     ulDiv.append(titleDiv, ul);
//     mainDiv.append(title, monthDuration, hourDuration, ulDiv);
//     mainDiv.style.border = `1px solid black`;
...
//     htmlDiv.appendChild(mainDiv);
//
//     mainDiv.innerText = `${item.title} - ${item.monthDuration}`;
// }
...
// row.placeholder = 'rows';
// let column = document.createElement("input");
// column.placeholder = 'columns';
// let textt = document.createElement("input");
// textt.placeholder = 'text';
//
// const button = document.createElement("button");
// button.innerText = `Click`;
//
// document.body.append(row, column, textt, button);
//
